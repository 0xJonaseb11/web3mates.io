...
export default function PrivacyPolicy() {
  ...
  return (
    <motion.div className="min-h-screen bg-gradient-to-br from-slate-50 to-purple-50 pt-20">
                ...
                <section id="how-we-use" className="scroll-mt-24 mt-12">
                  ...
                  <div className="space-y-4 text-gray-600">
                    ...
                    <ul className="space-y-3">
                      ...
                      <li className="flex items-start gap-3">
                        <FaUser className="w-4 h-4 text-blue-500 mt-0.5 flex-shrink-0" />
                        <span>
                ...
                <section id="cookies" className="scroll-mt-24 mt-12">
                  ...
                  <div className="space-y-4 text-gray-600">
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-start gap-3">
                        <FaDatabase className="w-4 h-4 text-pink-500 mt-0.5 flex-shrink-0" />
                        <span>
                          Analyze how users interact with our platform
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <FaShieldAlt className="w-4 h-4 text-pink-500 mt-0.5 flex-shrink-0" />
                        <span>
